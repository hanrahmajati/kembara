...
<div class="container-login-reg">
			<div class="wrap-regis100">
                <form method="POST" action="{{ route('partner.one.store') }}" class="regis100-form validate-form">
                @csrf
                    <span class="regis100-form-title p-b-43">
						Register as Partner
					</span>
                    <div class="form-horizontal">
                        <p class="sub-title">Contact Person Details</p>
                        <br>
				...
				<div class="regis100-img" style="background-image: url('{{ asset('assets/Style/image/bg-1.jpg') }}');">
				</div>
			</div>
		</div>
@endsection
